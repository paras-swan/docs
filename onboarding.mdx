...
2. If you haven’t already done so, please <a href="https://www.swanvision.ai/auth">sign up</a> using your email address. Choose the models you are interested in exploring and provide your billing information. You should receive an email with a magic link to authenticate your address.
...
1. Swan has a simplified billing model based on your consumption activity. Please review our [API pricing](/company/pricing).
